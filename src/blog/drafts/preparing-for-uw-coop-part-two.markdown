...
A certain danger when doing structured learning is not applying the knowledge you gain, and then losing it. Sometimes it isn&rsquo;t clear, though, how you&rsquo;re supposed to apply the knowledge in the course; this is why courses that tell you what to do with your knowledge are sometimes better than courses that don&rsquo;t give you any exercises.

The other form of learning, unstructured or self-directed learning, is good because you usually do it for the express purpose of trying to do something you don&rsquo;t know how to do; this means that you usually apply the knowledge immediately, and hence have a better chance of grasping it immediately.
